...
public class MyInfoView {
    ...
    private RelativeLayout rl_Flight_history,rl_setting;
    ...
    private void initView() {
        ...
        rl_Flight_history=(RelativeLayout) mCurrentView.findViewById(R.id.rl_Flight_history);
        ...
        rl_Flight_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(readLoginStatus()){
                    //跳转到播放记录界面
              //      Intent intent=new Intent(mContext,this);
               //     mContext.startActivity(intent);
                }else{
