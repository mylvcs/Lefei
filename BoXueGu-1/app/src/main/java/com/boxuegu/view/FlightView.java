...
public class FlightView {
    ...
    private List<FlightBean> cadl;
    public FlightView(FragmentActivity context) {
        mContext = context;
        // 为之后将Layout转化为view时用
    ...
    private void getFlightData() {
        try {
			...
			cbl = AnalysisUtils.getFlightInfos(is);//getFlightInfos(is)方法在下面会有说明
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
