...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void clearBottomImageState() {
        ...
        iv_Flight.setImageResource(R.drawable.main_flight_icon);
    ...
    public void setSelectedStatus(int index) {
        switch (index) {
            case 0:
                mFlightBtn.setSelected(true);
                iv_Flight.setImageResource(R.drawable.main_flight_icon_selected);
                tv_Flight.setTextColor(Color.parseColor("#0097F7"));
        ...
        switch (viewIndex) {
            case 0:
                ...
                if (mFlightView == null) {
                    ...
                    mBodyLayout.addView(mFlightView.getView());
                } else {
                    mFlightView.getView();
                }
                mFlightView.showView();
                break;
            case 1:
                //习题界面
