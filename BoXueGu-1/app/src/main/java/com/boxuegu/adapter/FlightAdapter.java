...
//	 * 设置数据更新界面
//	 */
//	public void setData(List<List<FlightBean>> cbl) {
//		this.cbl = cbl;
...
//	 */
//	@Override
//	public List<FlightBean> getItem(int position) {
...
////					R.layout.flight_list_item, null);
...
//		}
//		final List<FlightBean> list = getItem(position);
//		if (list != null) {
//			for (int i = 0; i < list.size(); i++) {
//				final FlightBean bean = list.get(i);
//				switch (i) {
//					case 0:// 设置左边图片与标题信息
